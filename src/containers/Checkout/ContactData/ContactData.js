...
class ContactData extends Component {
	...
	inputChangedHandler = (event, inputIdentifier) => {
		//console.log(event.target.value); //returns letters entered
		//remember to make clones, and avoid just using pointers
		/*
		const updatedOrderForm = {
			...this.state.orderForm
		};//inner objects also have pointers, so we do this vvvv
